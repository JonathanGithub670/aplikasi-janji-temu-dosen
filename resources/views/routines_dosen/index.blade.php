...
@section('breadcrumbs')
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Rutinitas Dosen</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">
                        Dashboard | <a href="{{ route('dashboard.daftar_dosen') }}"><strong>Rutinitas Dosen</strong></a>
                    </li>
                </ol>
            </div>
                    ...
                    <div class="card-footer bg-transparent border-top pt-0">
                        <div class="contact-links d-flex font-size-20">
                            <div class="flex-fill">
                                ...
                                <a href="{{ route('dashboard.routines.detail', $dosen->id) }}"><i class="bx bx-calendar"><span class="font-size-15 mb-1"> Atur Rutinitas </span></i></a>
                            </div>
                        </div>
                    </div>
                </div>
