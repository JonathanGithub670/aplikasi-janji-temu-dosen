        ...
        <div class="card">
            <div class="card-body">
                        ...
                        @can('isAdmin')
                            @forelse ($lists as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($item->datetime)->translatedFormat('l, d F Y H:i') }}
                                    </td>
                                    <td>
                                        @if ($item->status === 1)
                        ...
                        @elsecan('isDosen')
                            @forelse ($lists as $key => $item)
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        {{ \Carbon\Carbon::parse($item->datetime)->translatedFormat('l, d F Y H:i') }}</td>
                                    <td style="text-align:center">
                                        @if ($item->status === 1)
                                            <span class="badge bg-success"><i
                                                    class="bx bx-check-double font-size-16 align-middle me-2"></i>Diterima</span>
                ...
                <nav aria-label="Page navigation example">
                    <div class="pagination justify-content-end">{!! $lists->links('vendor.pagination.custom') !!} </div>
                </nav>
            </div>
        </div>
    </div>
