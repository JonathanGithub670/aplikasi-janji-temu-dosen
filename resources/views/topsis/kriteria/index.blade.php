        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active box-header">
                        <a href="{{ route('dashboard.topsis.kriteria') }}"><span class="badge bg-success box-title">  Buat Kriteria </span></a><span> |</span>
                    </li>
                    <li>
                        <a href="{{ route('dashboard.topsis.alternatif') }}"><span class="text-black"> Buat Alternatif</span></a><span> |</span>
                    </li>
                    <li>
...
@section('container')
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Halaman membuat Data Kriteria</h4>
                ...
                <div class="row" style="float: right">
                    <div>
                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light"
                            data-bs-toggle="modal" data-bs-target="#exampleModalkriteria" data-bs-whatever="@mdo"><i
                                class="bx bx-plus-medical label-icon"></i> Kriteria</button>
                        <div class="modal fade" id="exampleModalkriteria" tabindex="-1"
                            aria-labelledby="exampleModalLabelkriteria" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="#" method="POST">
                                        <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="atribute" class="col-form-label">Atribute:</label>
