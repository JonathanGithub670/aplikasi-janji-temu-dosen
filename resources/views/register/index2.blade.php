    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item active">Dashboard<a href="{{ route('register') }}"> | <strong>Buat Akun</strong></a> </li>
            </ol>
        </div>
    </div>
</div>
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('register') }}" method="POST" class="p-3 mt-2">
                ...
                <div>
                    <input type="text" class="form-control  @error('nim') is-invalid @enderror" name="nim" id="nim" placeholder="Masukkan NIM atau NIDN" autofocus required value="{{ old('nim') }}" autocomplete="off">
                    @error('nim')
                ...
                <div class="form-field d-flex align-items-center">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="NAMA" autofocus required value="{{ old('name') }}" autocomplete="off">
                    @error('name')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div>
            <input type="password" class="form-control  @error('password') is-invalid @enderror" name="password" id="password" placeholder="Password" autofocus required value="{{ old('password') }}" autocomplete="off">
            @error('password')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        {{-- <label for="password" class="form-label fs-5 mt-3">password</label>
                    <div class="form-field d-flex align-items-center">
                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Password" autofocus required value="{{ old('password') }}" autocomplete="off"><br>
        @error('password')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
    ...
    {{-- <label for="role" class="form-label fs-5 mt-3">Pilih role</label>
                    <select class="form-select form-select-m" aria-label=".form-select-lg example" id="pilih_role" onchange="pilihJabatan()" required>
    ...
    <label for="role" class="form-label fs-5 mt-3">Pilih role</label>
    <div>
        <select class="form-select form-select-m @error('role') is-invalid @enderror" aria-label=".form-select-lg example" id="pilih_role" onchange="pilihJabatan()" name="role" required>
            <option hidden>Open this select menu</option>
    ...
    {{-- <select id="role" class="form-select @error('role') is-invalid @enderror" aria-label="Default select example" name="role" required>
